...
const Navbar = () => {
  ...
  return (
      ...
      <div className='w-full h-auto flex justify-between items-center mx-5 my-5'>
         <h1 className='text-5xl text-amber-300 font-bold'>SaeResto</h1>
         <div className='w-1/2  flex justify-evenly items-center'>
              ...
              <h1 className='text-2xl text-amber-500 hover:text-white font-medium'>Menu</h1>
              <h1 className='text-2xl text-amber-500 hover:text-white font-medium'><Link to={"/Contact"}>Contact</Link></h1>

              <button className='text-white bg-amber-500 w-1/6 h-10'> BOOK A TABLE</button>
         </div>
      </div>
      </>
  )
